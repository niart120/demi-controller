...
| prerequisite | Qt shell、input capture、controller preview | `spec/wip/unit_014/PYSIDE6_APPLICATION_SHELL.md`, `spec/wip/unit_015/QT_INPUT_AND_CONTROLLER_PREVIEW.md` |
