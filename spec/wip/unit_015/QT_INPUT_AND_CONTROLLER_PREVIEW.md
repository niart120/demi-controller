...
物理mouseの操作結果は未記録である。以下は受入前に取得できた環境情報であり、DPIとpolling rateはvendor設定で確認できるまで推測しない。
...
| mouse DPI | 未確認 |
| polling rate | 未確認。vendor設定画面またはhardware仕様で1000 Hzを確認する必要がある |
| 物理操作結果 | 未記録。利用者による実mouse操作後にpacket / delta / frame、画面端、F12、focus lossの結果を追記する |
