...
| refactor-done | IMU headings, axis labels, and plots have separate readable regions at the minimum window size | regression | unit | red / green 2026-07-25、初回画像監査後に軸ラベルを追加修正、最終監査 `unit_046-imu-green-2` |
