...
| prerequisites | UI再設計milestone 1〜5の作業仕様と検証結果 | `spec/complete/unit_013/`、`spec/wip/unit_014/`〜`spec/wip/unit_017/` |
...
- `spec/complete/unit_013/`、`spec/wip/unit_014/`〜`spec/wip/unit_017/`
- `README.md`
...
| `spec/complete/unit_013/`、`spec/wip/unit_014/`〜`spec/wip/unit_018/` | modify | 最終TDD、検証、checklist、handoff結果 |
