...
| `uv run pytest tests/unit/input/test_publisher.py` | passed | 4 passed |
...
| `uv run ty check --no-progress` | passed | All checks passed |
| `uv run pytest tests/unit/input/test_yaw_pitch_model.py` | passed | 9 passed |
| `uv run ruff format --check src/demi/input/yaw_pitch_model.py tests/unit/input/test_yaw_pitch_model.py` | passed | 2 files already formatted |
| `uv run ruff check src/demi/input/yaw_pitch_model.py tests/unit/input/test_yaw_pitch_model.py` | passed | All checks passed |
| `uv run ty check --no-progress` | passed | All checks passed |
...
| `uv run ruff check src/demi/input src/demi/domain/mapping.py tests/unit/input/test_mapper.py` | passed | All checks passed |
| `uv run ty check --no-progress` | passed | All checks passed |
| `uv run pytest tests/unit/input/test_physical_input.py` | passed | 12 passed |
| `uv run ruff check src/demi/domain/physical_input.py tests/unit/input/test_physical_input.py` | passed | All checks passed |
| `uv run ty check --no-progress` | passed | All checks passed |
