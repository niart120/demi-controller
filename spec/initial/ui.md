...
- 本体: 上端が連続した幅広いフェイスプレートと、左右外側から下方へ連続するグリップを持つ独自の簡略シルエット。ショルダーとグリップを含む外接矩形の幅と高さの比を1.9:1から2.1:1にする
...
- L/R/ZL/ZR: 連続したフェイスプレート上段へ収める丸角矩形。幅はフェイスボタン直径の225%以内にする
- Plus/Minus/Home/Capture: 小型記号
- 左スティック、十字キー、ABXY: 左スティックとABXYをショルダー段の直下、十字キーを左下に置く
