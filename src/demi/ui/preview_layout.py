...
_RELATIVE_CONTROLS = {
    "zl": (0.105, 0.09, 0.095, 0.07),
    "l": (0.23, 0.09, 0.095, 0.07),
    "r": (0.675, 0.09, 0.095, 0.07),
    "zr": (0.80, 0.09, 0.095, 0.07),
    "dpad_up": (0.27, 0.50, 0.04, 0.096),
    "dpad_left": (0.23, 0.564, 0.06, 0.064),
    "dpad_right": (0.29, 0.564, 0.06, 0.064),
    "dpad_down": (0.27, 0.596, 0.04, 0.096),
    "x": (0.745, 0.28, 0.055, 0.07),
    "y": (0.68, 0.36, 0.055, 0.07),
    "a": (0.81, 0.36, 0.055, 0.07),
    "b": (0.745, 0.44, 0.055, 0.07),
...
def preview_layout(width: int, height: int) -> PreviewLayout:
    ...
    return PreviewLayout(
        ...
        gyro_bounds=_scaled_rect(content_bounds, 0.06, 0.89, 0.40, 0.102),
        accel_bounds=_scaled_rect(content_bounds, 0.54, 0.89, 0.40, 0.102),
        controls=controls,
    )
