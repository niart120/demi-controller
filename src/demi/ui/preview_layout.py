...
_RELATIVE_CONTROLS = {
    ...
    "dpad_up": (0.155, 0.30, 0.09, 0.065),
    "dpad_left": (0.11, 0.36, 0.09, 0.065),
    "dpad_right": (0.20, 0.36, 0.09, 0.065),
    "dpad_down": (0.155, 0.42, 0.09, 0.065),
...
def preview_layout(width: int, height: int) -> PreviewLayout:
    ...
    return PreviewLayout(
        ...
        body_bounds=_scaled_rect(content_bounds, 0.08, 0.16, 0.84, 0.60),
        left_grip_bounds=_scaled_rect(content_bounds, 0.11, 0.47, 0.15, 0.28),
        right_grip_bounds=_scaled_rect(content_bounds, 0.74, 0.47, 0.15, 0.28),
        status_bounds=_scaled_rect(content_bounds, 0.18, 0.80, 0.64, 0.055),
        gyro_bounds=_scaled_rect(content_bounds, 0.06, 0.87, 0.40, 0.12),
        accel_bounds=_scaled_rect(content_bounds, 0.54, 0.87, 0.40, 0.12),
        controls=controls,
    )
