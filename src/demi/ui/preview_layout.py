...
_RELATIVE_CONTROLS = {
    "zl": (0.12, 0.01, 0.095, 0.07),
    "l": (0.23, 0.01, 0.095, 0.07),
    "r": (0.675, 0.01, 0.095, 0.07),
    "zr": (0.785, 0.01, 0.095, 0.07),
...
def preview_layout(width: int, height: int) -> PreviewLayout:
    ...
    return PreviewLayout(
        ...
        gyro_bounds=_scaled_rect(content_bounds, 0.06, 0.78, 0.40, 0.102),
        accel_bounds=_scaled_rect(content_bounds, 0.54, 0.78, 0.40, 0.102),
        controls=controls,
    )
