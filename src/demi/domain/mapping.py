...
def default_profile() -> InputProfile:
    ...
    Returns:
        The 36-binding profile defined by the initial configuration.
    """
    return InputProfile(
        id="default",
        name="Default",
        ...
        bindings=(
            ...
            Binding("KEY:C", BindingTarget.BUTTON_Y),
            ...
            Binding("KEY:Z", BindingTarget.BUTTON_PLUS),
            Binding("KEY:X", BindingTarget.BUTTON_MINUS),
            Binding("KEY:F1", BindingTarget.BUTTON_HOME),
            Binding("KEY:G", BindingTarget.BUTTON_LEFT_STICK),
            Binding("KEY:H", BindingTarget.BUTTON_RIGHT_STICK),
