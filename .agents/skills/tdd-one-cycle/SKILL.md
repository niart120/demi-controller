---
name: tdd-one-cycle
description: "この Python repo の TDD Test List から 1 item だけを選び、red、green、必要な refactor まで 1 cycle 進める skill。ユーザが TDD の 1 サイクル、red/green/refactor、テストを1つ消化、spec/wip の TDD item 実装を依頼したときに使う。"
---
